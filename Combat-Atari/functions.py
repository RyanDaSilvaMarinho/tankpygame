...
def help_2player():
    ...
    while True:
        ...
        if ev.type == pygame.KEYDOWN:
            ...
            draw_text(screen, "Press [ENTER] To Begin", WHITE, 30, (WIDTH/2, (HEIGHT/2)+200))
            pygame.display.update()
...
def main_menu():
    ...
    while True:
        ...
        if ev.type == pygame.KEYDOWN:
            ...
            draw_text(screen, "Press [Enter] To Begin 2 player", WHITE, 40, (WIDTH/2, HEIGHT/2))
            draw_text(screen, "press [Q] To Quit",WHITE, 40, (WIDTH/2, (HEIGHT/2)+100))
            pygame.display.update()
